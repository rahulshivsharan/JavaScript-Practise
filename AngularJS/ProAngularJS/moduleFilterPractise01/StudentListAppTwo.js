angular.module("StudentListAppTwo").controller("StudentListCntrl",function($scope,$filter){
	$scope.data = [
		{
			id : 123,
			name : "John Grisham",
	...
	$scope.gradeFilterFn = function(student){
		return (student.Grade == "B") ? true : false;
	}
});	
